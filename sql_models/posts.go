...
func (o *Post) Comments(mods ...qm.QueryMod) commentQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"comments\".\"post_id\"=?", o.PostID),
	)
...
func (o *Post) PostVotes(mods ...qm.QueryMod) postVoteQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"post_votes\".\"post_id\"=?", o.PostID),
	)
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (postL) LoadPostVotes(ctx context.Context, e boil.ContextExecutor, singular bool, maybePost interface{}, mods queries.Applicator) error {
	var slice []*Post
	var object *Post
	...
	query := NewQuery(
		qm.From(`post_votes`),
		qm.WhereIn(`post_votes.post_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Post) SetUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	...
	values := []interface{}{related.UserID, o.PostID}
...
func (o *Post) AddPostVotes(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PostVote) error {
	...
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.PostID, rel.PostID, rel.UserID}
...
func FindPost(ctx context.Context, exec boil.ContextExecutor, postID int, selectCols ...string) (*Post, error) {
	postObj := &Post{}
	...
	query := fmt.Sprintf(
		"select %s from \"posts\" where \"post_id\"=$1", sel,
	)
...
func PostExists(ctx context.Context, exec boil.ContextExecutor, postID int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"posts\" where \"post_id\"=$1 limit 1)"
